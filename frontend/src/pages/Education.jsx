...
export default function Education() {
  ...
  return (
    <div id="education" ref={sectionRef} className="bg-white sm:h-[830px] h-[800px] w-full">
      <div className="text-center w-[90%] m-auto sm:pt-30 pt-10">
      ...
      <div className=" h-[30vh] w-[90%] m-auto mt-10 ">
