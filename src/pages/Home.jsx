...
function Home() {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (event) => {
      mouse.targetX = (event.clientX - mouse.windowHalfX) / mouse.windowHalfX;
      mouse.targetY = (event.clientY - mouse.windowHalfY) / mouse.windowHalfY;
    };
    ...
    const animate = () => {
      if (spaceObject) {
        ...
        // Apply rotations
        spaceObject.rotation.y = -mouse.x * 0.5;  // horizontal rotation
        spaceObject.rotation.x = mouse.y * 0.3;   // vertical rotation
        spaceObject.rotation.z += 0.010;          // continuous rotation
      }
    ...
    const handleResize = () => {
      ...
      mouse.windowHalfX = width / 2;
      mouse.windowHalfY = height / 2;
  ...
  return (
    <div id="home" className="relative w-full h-screen">
      ...
      />
      <div className="absolute top-0 left-4 sm:left-[200px] p-10 text-white z-0">
        <h1 className="heading text-5xl sm:text-7xl md:text-8xl font-bold leading-tight">
          Mern <br /> Developer.
        </h1>
      </div>

      <div className="absolute bottom-[30%] sm:bottom-[300px] right-8 sm:right-20 text-[#ADADAD] w-[80%] sm:w-[30%] text-start z-0">
